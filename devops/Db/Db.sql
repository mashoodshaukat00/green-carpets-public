...
GO
/****** Object:  Table [dbo].[Subscription]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Subscription]') AND type in (N'U'))
DROP TABLE [dbo].[Subscription]
GO
/****** Object:  Table [dbo].[Service]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Service]') AND type in (N'U'))
DROP TABLE [dbo].[Service]
GO
/****** Object:  Table [dbo].[Role]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Role]') AND type in (N'U'))
DROP TABLE [dbo].[Role]
GO
/****** Object:  Table [dbo].[ProductCategory]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ProductCategory]') AND type in (N'U'))
DROP TABLE [dbo].[ProductCategory]
GO
/****** Object:  Table [dbo].[Product]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Product]') AND type in (N'U'))
DROP TABLE [dbo].[Product]
GO
/****** Object:  Table [dbo].[PaymentMethod]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[PaymentCardType]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[MM_CustomerSubscription]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[InvoiceType]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InvoiceType]') AND type in (N'U'))
DROP TABLE [dbo].[InvoiceType]
GO
/****** Object:  Table [dbo].[InvoiceStatusType]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[DeliveryReport]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[DeliveryAddress]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[CustomerType]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Customer]') AND type in (N'U'))
DROP TABLE [dbo].[Customer]
GO
/****** Object:  Table [dbo].[Country]    Script Date: 17/08/2021 4:52:36 pm ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Country]') AND type in (N'U'))
DROP TABLE [dbo].[Country]
GO
/****** Object:  Table [dbo].[CompanyOwner]    Script Date: 17/08/2021 4:52:36 pm ******/
...
GO
/****** Object:  Index [UQ__CompanyO__1788CC4D01782745]    Script Date: 17/08/2021 4:52:37 pm ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [uc_Countries_Iso]    Script Date: 17/08/2021 4:52:37 pm ******/
ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [uc_Countries_Iso] UNIQUE NONCLUSTERED 
(
	[Iso] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [UQ__Customer__1788CC4D0C21D608]    Script Date: 17/08/2021 4:52:37 pm ******/
